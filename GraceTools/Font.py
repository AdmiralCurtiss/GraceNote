...
class Font(QtGui.QWidget):
    def __init__(self, parent=None):
        ...
        self.rangeList[0].setChecked(True)
        self.rangeList[1].setChecked(True)
        self.rangeList[2].setChecked(True)
        self.rangeList[3].setChecked(True)
        self.rangeList[6].setChecked(True)

        self.fontButton = QtGui.QPushButton('Choose Font')
        self.fontLabel = QtGui.QLabel('No font selected')
        self.fontButtonAlt = QtGui.QPushButton('Choose alt Font')
        self.fontAltLabel = QtGui.QLabel('No alt font selected')

        self.button = QtGui.QPushButton('Generate')
        
        self.fontButton.released.connect(self.fontBox)
        self.fontButtonAlt.released.connect(self.fontBoxAlt)
        ...
        layout.addWidget(self.fontButtonAlt)
        layout.addWidget(self.fontAltLabel)
    ...
    def fontBox(self):
        tmpfont = QtGui.QFontDialog.getFont(QtGui.QFont("Square 721 Blk", 22), self, 'Choose a Font');
        if tmpfont[1] == True:
            self.font = tmpfont[0]
    ...
    def fontBoxAlt(self):
        tmpfont = QtGui.QFontDialog.getFont(QtGui.QFont("Square 721 Blk", 22), self, 'Choose a Font');
        if tmpfont[1] == True:
            self.fontAlt = tmpfont[0]
            self.fontAltLabel.setText('{0}, {1} pt'.format(self.fontAlt.family(), self.fontAlt.pointSize()))
    ...
    def Generate(self):
        ...
        LatinSet.extend([0x27, 0x27, 0x22, 0x22, 0x28, 0x29]) #quotations and braces
...
#            p += 1
        ...
        pen = QtGui.QPen(QtGui.QColor(255, 255, 255, 0), 1, QtCore.Qt.SolidLine, QtCore.Qt.RoundCap, QtCore.Qt.RoundJoin)
